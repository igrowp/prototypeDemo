...
//     private file: File) {
//     this.pubDbProvider.getFromStorage("URL").then((val) => {
//       if (val != null && val != "") {
...
//     return new Promise((resolve, reject) => {
//       this.http.post(this.Local_URL + "inv/getInvNoticeByOrg",JSON.stringify(obj))
//         .map(res => res.json())
//         .subscribe((data) => {
//           resolve(data);
//           alert(data);
...
//     // alert("进入");
//     // // const body = {leadingOrg: "user.username"};
//     // // this.http.post('http://10.88.133.45:8080/ionicApp/inv/login',JSON.stringify(body) )
...
//     // const body = {leadingOrg: "user.username"};
//     // this.http.post('http://10.88.133.45:8080/ionicApp/inv/login1', 
//     //             'nameOrEmail=li&password=123',
